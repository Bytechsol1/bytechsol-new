...
import lig from "../../../assets/images/webnew1.png";
        ...
        <div className="dg-hero-left">
          <div className="dg-hero-title-wrap">
            <h1 className="dg-hero-heading" data-aos="fade-down">
              {heroContent.title ? (
                <>
                  {heroContent.title.split("Development")[0]}
                  <br />
                  Development
                </>
              ) : (
          ...
          <div className="dg-hero-body-wrap">
            ...
            <a href={heroContent.buttonLink || "#contact"} className="dg-hero-cta" data-aos="fade-up">
              {heroContent.buttonText || "Start Your Website Project Today"} <span className="arrow">↗</span>
            </a>
          </div>
        </div>
        <div className="dg-hero-right photo-right">
          <img src={lig} alt="Web Design and Development" className="dg-hero-img" />
        </div>
      </section>
