...
import wa from "../../../assets/images/webappnew.png";
  ...
  return (
    <>
      ...
      <section className="dg-hero-section">
        <div className="dg-hero-left">
          <div className="dg-hero-title-wrap">
            <h1 className="dg-hero-heading" data-aos="fade-down">
              Building Powerful <br /> Web Apps &amp; Software <br /> for the Digital Era
            </h1>
          </div>
        ...
        <div className="dg-hero-right webapp-right" style={{ overflow: "visible" }}>
          <img
            src={wa}
            alt="Web App 3D"
            style={{
