...
import id from "../../../assets/images/ideation.png";
...
const cards = [
  ...
  },
  {
    color: "s-bg",
    image: bl,
    title: ["Web Apps Built for Growth"],
    items: [
  ...
  },
  {
    color: "t-bg",
    image: pl,
    title: ["Custom Software, Real Results"],
    items: [
        ...
        <div className="container d-flex align-items-center justify-content-between">
          <div className="dg-products-content">
            ...
            <p className="dg-products-description">
              Transform your business with our web app and software development
              services. We develop scalable, secure, and usable applications,
              such as bespoke web applications and enterprise software, and
              deliver new solutions that enhance performance, expansion, and
        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-6 px-5">
            ...
            <p className="webdesign-desc1">
              Our web app services provide high-performing, reliable, and
              scalable applications that meet your business objectives. We
              specialise in developing apps that streamline workflows, improve
              customer experiences, and enable business development in
              industries throughout the planning process to deployment.
            </p>
        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-6 px-5">
            ...
            <p className="webdesign-desc">
              Using our software development solutions, business enterprises can
              experience reliable, scalable, and custom software, a software
              that is tailor-made to ease operations and enable businesses to go
              forth. Be it enterprise-level systems or custom applications, we
              blend innovation with industry best practices to help deliver
              software that improves performance and helps long-lasting business
              success.
            </p>
      ...
      <section className="webdesign-section1 container-fluid py-5">
        <div className="row align-items-center">
          ...
          <div className="col-lg-6 px-5">
            ...
            <p className="webdesign-desc1">
              Our Progressive Web App development solution provides quick,
              dependable, and interactive experiences that are compatible with
              all devices. PWAs are superior in both web and mobile, and this
              makes them fast, can be accessed even when offline, and their
              interface resembles that of an application, making them easy to
              use and increasing business.
            </p>
      ...
      <section className="webdesign-section container-fluid py-5">
        <div className="row align-items-center">
          ...
          <div className="col-lg-6 px-5">
            ...
            <p className="webdesign-desc">
              Our SaaS application development solutions enable businesses to
              have scalable, secure, and easy-to-use solutions that meet their
              individual needs. Our cloud applications simplify workflows,
              improve collaboration, and ensure accessibility anywhere,
              regardless of the Internet connection- all of which helps
              businesses remain competitive in the current fast-paced digital
              landscape.
            </p>
      ...
      <section className="webdesign-section1 container-fluid py-5">
        <div className="row align-items-center">
          ...
          <div className="col-lg-6 px-5">
            ...
            <p className="webdesign-desc1">
              Our enterprise application development solutions are powerful,
              scalable, and secure solutions that can optimize operations,
              improve effectiveness, and enable businesses to expand. Since
              automation of workflows to system integration, we develop custom
              enterprise software that may suit the needs of your organization
              and drive digital transformation across departments.
            </p>
