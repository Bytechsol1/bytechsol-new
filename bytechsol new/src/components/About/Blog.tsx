...
function getInitialBlogPosts() {
  const initialData = (globalThis as { __INITIAL_WP_DATA__?: { blogPosts?: any[] } }).__INITIAL_WP_DATA__;
  return initialData?.blogPosts ?? [];
}
...
const Blog = () => {
  const initialPosts = getInitialBlogPosts();
