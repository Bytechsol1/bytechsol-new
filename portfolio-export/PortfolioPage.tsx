...
import { motion, AnimatePresence } from 'framer-motion'; // Changed to framer-motion as it's more standard
...
const projects = [
    ...
    },
    {
        ...
        description: 'Luxury designer handbags and accessories with a focus on premium aesthetics.',
    ...
    },
    {
        ...
        description: 'Leading pet health and wellness brand with high-performance web solutions.',
        tags: ['React', 'Scale', 'E-commerce']
    }
];

const categories = ['All', 'E-commerce', 'Shopify', 'WordPress', 'Squarespace'];
            ...
            <section className="py-32 px-6 border-t border-white/5">
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16">
                        ...
                        <h2 className={`text-4xl md:text-5xl font-medium mb-12 text-[#4A7DFF]`}>
